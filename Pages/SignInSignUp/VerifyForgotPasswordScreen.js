...
const VerifyForgotPasswordScreen = ({navigation}) => {
  ...
  <Wrapper>
    <ButtonWrapper>
      ...
      <Text style={{color: '#eeeeee', fontSize: 25, textAlign: 'center', fontWeight: 'bold'}}>Enter Verification Code</Text>
      ...
      <TextInput
        ...
        multiline
        numberOfLines={3}
        style={styles.VerificationInputStyleClass}
        />
        <TextInput
        placeholder="X"
        placeholderTextColor={'#696969'}
        ...
        <Button style={{ bottom: 50, width: 200, alignItems: 'center', color: '#1c1c1c'}} 
           transparent title="Resend Code"/>
