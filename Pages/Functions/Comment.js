...
const Comment =(props) => {
  ...
  return(
      <View style={{alignItems: 'center', width: '98.5%', left: 5}}>

      <View style= {{flexDirection: 'row', width: '95%', top: 10, justifyContent: 'space-between', right: 7.5}}>
      <View style = {{ flexDirection : 'row'}}>

      <TouchableOpacity onPress={()=>navigation.navigate('Portrait')} style={{
      left: 2.5, flexDirection: 'row', backgroundColor: '#000000', width: '72%'}}>
      ...
      <Text style={{color: props.userColor, fontSize: 15, top: 0, left: 6,fontWeight: 'bold', width: '100%', overflow: 'hidden', height: 20}}>{props.userName}</Text>
      <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
      </View>
      </View>
      <Text style={{fontSize: 12, opacity: .60, color: '#ffffff', left: 0, bottom: .5}}>{props.timeSince}</Text>
      </View>
      </TouchableOpacity>
      ...
      <View style={{width: '100%', left: 0, bottom: 12.5}}>
      <View style={{height: 0}}/>
      ...
      <View style={{flexDirection: 'row', top: 2.5, right: 57.5, height: 17, width: '102.5%', justifyContent: 'space-between'}}>
